...
contract Receiver is Initializable {
    ...
    function initialize(address _LINAddress, address _potAddress, address _governanceEnforcerProxy)
        public
        initializer
    {
    ...
    function changeSubscriptionFee(uint _updatedSubscriptionFee) external onlyGovernanceEnforcer returns(bool) {
