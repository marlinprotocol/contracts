...
contract FundManager is Initializable {
    ...
    function createFund(
        ...
        require(_endEpoch > _lastDrawnEpoch, "Fund should start before endEpoch");
        uint potForFund = _inflationPerEpoch.mul(_endEpoch.sub(_lastDrawnEpoch));
        require(unallocatedBalance >= potForFund,
