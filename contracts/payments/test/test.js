...
contract("MarlinPaymentChannel", () => {
  ...
  it("Defined Account in the Constructor should have balance", async () => {
    const bal = await marlinPaymentChannel.getBalance(
  ...
  it("Defray Function Should Execute and Disburse Amount Successfully", async () => {
    await marlinPaymentChannel.defray(
      "",
  ...
  it("Amount Should be Deducted and Added in others Accounts correctly", async () => {
    const senderBalance = await marlinPaymentChannel.getBalance(
      "0xd03ea8624C8C5987235048901fB614fDcA89b117"
    );
    assert(senderBalance.toNumber() == initialBalance - 20);
    const firstPersonBalance = await marlinPaymentChannel.getBalance(
      "0x90f8bf6a479f320ead074411a4b0e7944ea8c9c1"
    );
    assert(firstPersonBalance.toNumber() == 8, "Funds to first not received");
    const secondPersonBalance = await marlinPaymentChannel.getBalance(
      "0xffcf8fdee72ac11b5c542428b35eef5769c409f0"
    );
    assert(secondPersonBalance.toNumber() == 6, "Funds to second not received");
    const thirdPersonBalance = await marlinPaymentChannel.getBalance(
      "0x22d491bde2303f2f43325b2108d26f1eaba1e32b"
    );
    assert(thirdPersonBalance.toNumber() == 4, "Funds to third not received");
    const fourthPersonBalance = await marlinPaymentChannel.getBalance(
  ...
  it("Amount Should be Deducted and Added in others Accounts Correctly After Double Spend Attack", async () => {
    ...
    assert(
      secondPersonBalance.toNumber() == 12,
      "Funds to second not received"
    );
    const thirdPersonBalance = await marlinPaymentChannel.getBalance(
      "0x22d491bde2303f2f43325b2108d26f1eaba1e32b"
    );
