...
const publicKey = utils.hexStringToArr('f1cb00a966c77dcc6d2c59c8f5181a4a68ed374e8b0412b08e1ee7a81059b7e34e419719eff5c26095a6c34afd936368ae2af7a5e85fcefd1201e2a72497ca48');
...
describe('crypto', () => {
  describe('verify', () => {
    it('should verify signature with test data', () => {
      const isVerified = crypto.verify(testMsg, testSignature, publicKey);
