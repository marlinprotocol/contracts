...
contract('Capacity', function(accounts){
    ...
    it("check overlapping stake", function(){
        ...
        return tokenInstance.transfer(accounts[10], 0x5555555555)
        .then(function(){
            return tokenInstance.increaseAllowance(capacityAddress, 0x5555555555, {from: accounts[10]});
        })
        .then(function(){
            return capacityInstance.deposit((0x5555555555 - 6000), {from: accounts[10]});
        })
        .then(function(){
