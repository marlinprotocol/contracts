 ...
 * @property {String} signature - Signature validating certificate, signed by node
 */
class ClaimCertificate {
   ...
   * @param {String} [signature] - Signature validating certificate, signed by node
   */
   ...
   *
   * @param {String} nodePrivateKey - Node's private key
