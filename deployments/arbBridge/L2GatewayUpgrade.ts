...
async function main() {
  ...
  if(addresses[chainId] === undefined || addresses[chainId]['PondGateway'] === undefined) {
  ...
  let l2Gateway = await upgrades.upgradeProxy(addresses[chainId]["PondGateway"], L2Gateway, { kind: "uups" });
